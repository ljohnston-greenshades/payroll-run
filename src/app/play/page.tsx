...
export default async function PlayPage({
  ...
  return (
    <main className="relative flex h-[100svh] flex-col items-stretch overflow-hidden md:h-[100dvh]">
      ...
      <div
        className={`relative z-10 flex flex-1 flex-col items-center justify-center px-3 pt-3 pb-[max(5rem,env(safe-area-inset-bottom)+3rem)] md:p-6 md:pb-6 lg:p-8 lg:pb-8 ${
